...
有自己用的好的脚本 或是 平时常用但没有写成脚本的功能，欢迎提供（[提交Issue](https://github.com/superhj1987/awesome-scripts/issues))和分享（[Fork后提交代码](https://github.com/superhj1987/awesome-scripts/fork)）！ :sparkling_heart:
